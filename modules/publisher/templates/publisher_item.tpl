...
<div class="item">
    ...
    <div class="itemBody">
        ...
        <div class="itemText">
			...
			<{if $item.customfields.add_title}>
			<div class="cf-field">
				<strong>İlave Başlık:</strong>
				<span><{$item.customfields.add_title}></span>
			</div>
			<{/if}>
			
			<hr>
			<{if $item.customfields.list_typ}>
			<div class="cf-field">
				<strong>İlave Başlık:</strong>
				<span><{$item.customfields.list_typ}></span>
			</div>
			<{/if}>
			<hr>
			<{if $item.customfields.item_heyula}>
			<div class="cf-field">
				<strong>İlave Başlık:</strong>
				<span><{$item.customfields.item_heyula}></span>
			</div>
			<{/if}>			
